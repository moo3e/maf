...
export default function Index() {
  return (
    <>
      <section id="hero" aria-labelledby="hero-heading" className="w-full">
        <div className="relative h-[60vh] min-h-[520px] w-full overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute inset-0">
              {/* Background hero image: use a large wallpaper from public or a placeholder gradient */}
              <div className="h-full w-full bg-[url('/images/hero.jpg')] bg-cover bg-center"></div>
              <div className="absolute inset-0 bg-black/55"></div>
            </div>
            <div className="container relative mx-auto flex h-full max-w-6xl items-end">
              <div className="pb-20">
                <h1 className="text-white font-heading text-5xl leading-tight sm:text-6xl md:text-7xl lg:text-8xl">
                ...
                <div className="mt-6">
                  <Link href="/home" className="inline-block rounded-md bg-red-600 px-6 py-3 text-white shadow-sm hover:bg-red-700">
                    Browse Now
                  </Link>
                </div>
              </div>
