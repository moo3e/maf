      ...
      <div className="flex items-center gap-6 md:gap-10">
        <Link
          ...
          <div className="flex items-center space-x-3">
            <Icons.logo className="h-6 w-6 text-red-500" aria-hidden="true" />
            <span className="inline-block font-bold text-red-500 text-xl md:text-2xl">
              MafShows
            </span>
